def makeConvertBamToSamScript(bismarkSortedBamFileListFileName, suffix, scriptFileName):
	...
	for line in bismarkSortedBamFileListFile:
		...
		scriptFile.write("samtools view -h -o " + outputFileName + " " + bismarkSortedBamFileName + "\n")
...
if __name__=="__main__":
	...
	makeConvertBamToSamScript(bismarkSortedBamFileListFileName, suffix, scriptFileName)
