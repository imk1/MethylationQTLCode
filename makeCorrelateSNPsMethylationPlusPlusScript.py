def makeCorrelateSNPsMethylationScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileName, codePath, pythonPath):
	...
	for line in SNPMethylFileListFile:
		...
		cmd = pythonPath + "/" + "python " + codePath + "/" + "correlateSNPsMethylationPlusPlus.py"
...
if __name__=="__main__":
	...
	makeCorrelateSNPsMethylationScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileName, codePath, pythonPath)
