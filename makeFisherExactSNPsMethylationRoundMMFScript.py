def makeFisherExactSNPsMethylationRoundMMFScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, minMethylCutoff, scriptFileName, codePath, pythonPath):
	# Make a script that will run fisherExactSNPsMethylationRound.py on each file in a list
	...
	for line in SNPMethylFileListFile:
		...
		cmd = pythonPath + "/" + "python " + codePath + "/" + "fisherExactSNPsMethylationRoundMMF.py"
...
if __name__=="__main__":
	...
	makeFisherExactSNPsMethylationRoundMMFScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, minMethylCutoff, scriptFileName, codePath, pythonPath)
