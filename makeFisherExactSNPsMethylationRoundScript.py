def makeFisherExactSNPsMethylationRoundScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileName, codePath, pythonPath):
	...
	for line in SNPMethylFileListFile:
		...
		cmd = pythonPath + "/" + "python " + codePath + "/" + "fisherExactSNPsMethylationRound.py"
...
if __name__=="__main__":
	...
	makeFisherExactSNPsMethylationRoundScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileName, codePath, pythonPath)
