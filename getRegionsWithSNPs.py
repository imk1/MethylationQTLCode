...
def getRegionsWithSNPs(regionsFileName, SNPsFileName, outputFileName):
	...
	for line in SNPsFile:
		...
		while (region[2] < SNPStart) and (region[0] == lineElements[0]):
		...
		while (region[0] == lineElements[0]) and ((region[1] <= SNPEnd) and (region[2] >= SNPStart)):
...
if __name__=="__main__":
	...
	getRegionsWithSNPs(regionsFileName, SNPsFileName, outputFileName)