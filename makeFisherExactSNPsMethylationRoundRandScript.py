def makeFisherExactSNPsMethylationRoundRandScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileName, codePath, pythonPath):
...
if __name__=="__main__":
	...
	makeFisherExactSNPsMethylationRoundRandScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileName, codePath, pythonPath)
