function [pValsPooled, pValsIndivsGenotype] = simulateRandomReadsNegBinFTestRegressWithParamsScaleHWPlusPlus(numAlleles, numDevFromPerfectCorr, negBinParams, numReadsMean, numReads, numSimulations, MAF)
