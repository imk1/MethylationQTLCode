def makeGetNumReadsForFisherExactSNPsMethylationScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileName, codePath, pythonPath):
	...
	for line in SNPMethylFileListFile:
		...
		cmd = pythonPath + "/" + "python " + codePath + "/" + "getNumReadsForFisherExactSNPsMethylationPlusPlus.py"
...
if __name__=="__main__":
	...
	makeGetNumReadsForFisherExactSNPsMethylationScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileName, codePath, pythonPath)
