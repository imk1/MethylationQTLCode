...
def outputFisherExactRoundRand(SNP, methyl, SNPVec, methylVec, minReadsCutoff, minReadsCutoffSingleMinor, readsToMinMinorReads, SNPMethylFisherExactFile):
...
def fisherExactSNPsMethylationRoundRand(SNPMethylFileName, SNPMethylFisherExactFileName, readsToMinMinorReads):
	...
	for line in SNPMethylFile:
		...
		if (currentSNP != lastSNP) or (currentMethyl != lastMethyl):
			...
			outputFisherExactRoundRand(lastSNP, lastMethyl, SNPVec, methylVec, minReadsCutoff, minReadsCutoffSingleMinor, readsToMinMinorReads, SNPMethylFisherExactFile)
			lastSNP = currentSNP
...
if __name__=="__main__":
	...
	fisherExactSNPsMethylationRoundRand(SNPMethylFileName, SNPMethylFisherExactFileName, readsToMinMinorReads)
