...
def correlateSNPsMethylationPlus(SNPMethylFileName, SNPMethylCorrsFileName, minReadsCutoff, MAFCutoff, methylCutoff):
...
if __name__=="__main__":
	...
	correlateSNPsMethylationPlus(SNPMethylFileName, SNPMethylCorrsFileName, minReadsCutoff, MAFCutoff, methylCutoff)
