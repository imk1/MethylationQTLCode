...
def makeGrepSortSNPsMethylPlusScript(readsFileName, chromListFileName, scriptFileName):
	...
	for chrom in chromList:
		...
		scriptFile.write("zgrep -P '" + chrom + "\\t' " + readsFileName + " | sort -k5,5 -k6,6n -k2,2 -k3,3n -T /tmp | gzip > " + outputFileName + "\n")
	scriptFile.close()
...
if __name__=="__main__":
   ...
   makeGrepSortSNPsMethylPlusScript(readsFileName, chromListFileName, scriptFileName)
