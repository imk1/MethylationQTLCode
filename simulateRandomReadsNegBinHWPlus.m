function [pValsPooled, pValsIndivsGenotype, negBinParamsPooled, negBinParamsIndivs] = simulateRandomReadsNegBinHWPlus(numAlleles, numDevFromPerfectCorr, numReads, numSimulations, MAF, numReadsData)
...
% distribution whose parameters have been fit to the data
