...
def outputFisherExactRoundMMFRand(SNP, methyl, SNPVec, methylVec, minReadsCutoff, minReadsCutoffSingleMinor, readsToMinMinorReads, SNPMethylFisherExactFile, minMethylCutoff):
	# Compute and output the Fisher's exact test p-values if the reads, MAF, and methylation cutoffs are satisfied
	# Shuffles methylation states before computing p-values
...
def fisherExactSNPsMethylationRoundMMFRand(SNPMethylFileName, SNPMethylFisherExactFileName, readsToMinMinorReads, minMethylCutoff):
	...
	for line in SNPMethylFile:
		...
		if (currentSNP != lastSNP) or (currentMethyl != lastMethyl):
			...
			outputFisherExactRoundMMFRand(lastSNP, lastMethyl, SNPVec, methylVec, minReadsCutoff, minReadsCutoffSingleMinor, readsToMinMinorReads, SNPMethylFisherExactFile, minMethylCutoff)
			lastSNP = currentSNP
...
if __name__=="__main__":
	...
	fisherExactSNPsMethylationRoundMMFRand(SNPMethylFileName, SNPMethylFisherExactFileName, readsToMinMinorReads, minMethylCutoff)
