function [pValsPooled, pValsIndivsGenotype] = simulateRandomReadsNegBinWithParamsScaleHWPlusPlus(numAlleles, numDevFromPerfectCorr, negBinParams, numReadsMean, numReads, numSimulations, MAF)
