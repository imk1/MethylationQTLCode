function [pValsPooled, pValsIndivsGenotype] = simulateRandomReadsNoDistrHWPlus(numAlleles, numDevFromPerfectCorr, numReads, numSimulations, MAF)
...
numReadsIndivs = round(numReadsPerIndiv * ones(numSimulations, numIndivs)); % ROUNDING TO THE NEAREST NUMBER OF INDIVIDUALS
...
for i = 1:numSimulations
    ...
    randIndexesPooled = randi(numAlleles, [numReads, 1]);
