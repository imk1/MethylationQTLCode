def makeFisherExactSNPsMethylationPlusScript(SNPMethylFileListFileName, suffix, minReadsCutoff, MAFCutoff, methylCutoff, methylRatioCutoff, scriptFileName, codePath, pythonPath):
	...
	for line in SNPMethylFileListFile:
		...
		cmd = pythonPath + "/" + "python " + codePath + "/" + "fisherExactSNPsMethylationPlusRand.py"
		scriptFile.write(cmd + " " + SNPMethylFileName + " " + outputFileName + " " + str(minReadsCutoff) + " " + str(MAFCutoff) + " " + str(methylCutoff) + " " + str(methylRatioCutoff) + "\n")
...
if __name__=="__main__":
	...
	makeFisherExactSNPsMethylationPlusScript(SNPMethylFileListFileName, suffix, minReadsCutoff, MAFCutoff, methylCutoff, methylRatioCutoff, scriptFileName, codePath, pythonPath)
