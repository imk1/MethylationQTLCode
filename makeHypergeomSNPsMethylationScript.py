def makeHypergeomSNPsMethylationScript(SNPMethylFileListFileName, suffix, minReadsCutoff, MAFCutoff, methylCutoff, scriptFileName, codePath):
	...
	for line in SNPMethylFileListFile:
		...
		cmd = "python " + codePath + "/" + "hypergeomSNPsMethylation.py"
...
if __name__=="__main__":
	...
	makeHypergeomSNPsMethylationScript(SNPMethylFileListFileName, suffix, minReadsCutoff, MAFCutoff, methylCutoff, scriptFileName, codePath)
