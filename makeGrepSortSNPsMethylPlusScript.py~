...
def makeGrepSortSNPsMethylScript(readsFileName, chromListFileName, scriptFileName):
	...
	for chrom in chromList:
		...
		scriptFile.write("zgrep -P '" + chrom + "\\t' " + readsFileName + " | sort -k6,6 -k7,7n -k2,2 -k3,3n -T /tmp | gzip > " + outputFileName + "\n")
	scriptFile.close()
...
if __name__=="__main__":
   ...
   makeGrepSortSNPsMethylScript(readsFileName, chromListFileName, scriptFileName)
