def outputFisherExact(SNP, methyl, SNPVec, methylVec, minReadsCutoff, MAFCutoff, methylCutoff, methylRatioCutoff, SNPMethylFisherExactFile):
...
def fisherExactSNPsMethylation(SNPMethylFileName, SNPMethylFisherExactFileName, minReadsCutoff, MAFCutoff, methylCutoff, methylRatioCutoff):
	...
	for line in SNPMethylFile:
		...
		if (currentSNP != lastSNP) or (currentMethyl != lastMethyl):
			...
			outputFisherExact(lastSNP, lastMethyl, SNPVec, methylVec, minReadsCutoff, MAFCutoff, methylCutoff, methylRatioCutoff, SNPMethylFisherExactFile)
			lastSNP = currentSNP
...
if __name__=="__main__":
	...
	fisherExactSNPsMethylation(SNPMethylFileName, SNPMethylFisherExactFileName, minReadsCutoff, MAFCutoff, methylCutoff, methylRatioCutoff)
