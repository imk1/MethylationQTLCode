function [mQTLsSimulated, mQTLsRandListSimulated] = getmQTLsSimulatedNoRound(locationsBetasIndividualsMethylFileName, genotypesFiltFileName, SNPMethylFileName, numPerms, numSimulatedReads)
