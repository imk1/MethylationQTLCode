def outputFisherExact(SNP, methyl, SNPVec, methylVec, minReadsCutoff, MAFCutoff, methylCutoff, SNPMethylFisherExactFile):
...
def fisherExactSNPsMethylation(SNPMethylFileName, SNPMethylFisherExactFileName, minReadsCutoff, MAFCutoff, methylCutoff):
	...
	for line in SNPMethylFile:
		...
		if (currentSNP != lastSNP) or (currentMethyl != lastMethyl):
			...
			outputFisherExact(lastSNP, lastMethyl, SNPVec, methylVec, minReadsCutoff, MAFCutoff, methylCutoff, SNPMethylFisherExactFile)
			lastSNP = currentSNP
...
if __name__=="__main__":
	...
	fisherExactSNPsMethylation(SNPMethylFileName, SNPMethylFisherExactFileName, minReadsCutoff, MAFCutoff, methylCutoff)
