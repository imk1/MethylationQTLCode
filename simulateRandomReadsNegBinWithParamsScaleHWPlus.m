function [pValsPooled, pValsIndivsGenotype] = simulateRandomReadsNegBinWithParamsScaleHWPlus(numAlleles, numDevFromPerfectCorr, negBinParams, numReadsMean, numReads, numSimulations, MAF)
...
numReadsIndivs = round((numReads * nbinrnd(negBinParams(1), negBinParams(2), numSimulations, numIndivs)) / (numReadsMean * numIndivs));
