def makeRemoveMethylWithSNPsPlusGenomeSubsetScript(bismarkMethylationFileListFileName, regionsWithSNPsFileName, CGDist, outputFileNameSuffix, scriptFileName, codePath):
	...
	for line in bismarkMethylationFileListFile:
		...
		scriptFile.write("python " + codePath + "/" + "removeMethylWithSNPsPlusGenomeSubset.py " + bismarkMethylationFileName + " " + regionsWithSNPsFileName + " " + str(CGDist) + " " + outputFileName + "\n")
...
if __name__=="__main__":
	...
	makeRemoveMethylWithSNPsPlusGenomeSubsetScript(bismarkMethylationFileListFileName, regionsWithSNPsFileName, CGDist, outputFileNameSuffix, scriptFileName, codePath)
