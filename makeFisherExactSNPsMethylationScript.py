def makeFisherExactSNPsMethylationScript(SNPMethylFileListFileName, suffix, minReadsCutoff, MAFCutoff, methylCutoff, scriptFileName, codePath, pythonPath):
	...
	for line in SNPMethylFileListFile:
		...
		cmd = pythonPath + "/" + "python " + codePath + "/" + "fisherExactSNPsMethylation.py"
...
if __name__=="__main__":
	...
	makeFisherExactSNPsMethylationScript(SNPMethylFileListFileName, suffix, minReadsCutoff, MAFCutoff, methylCutoff, scriptFileName, codePath, pythonPath)
