def makeGroupNonPerfectLDSNPsSNPsMethylScript(SNPMethylFileNameListFileName, perfectLDSNPsFileNameListFileName, chromListFileName, outputFileNameSuffix, distanceCutoff, rCutoff, scriptFileName, codePath):
	...
	for line in SNPMethylFileNameListFile:
		...
		cmd = "python " + codePath + "/" + "groupNonPerfectLDSNPsMethyl.py"
...
if __name__=="__main__":
	...
	codePath = sys.argv[8]
	makeGroupNonPerfectLDSNPsSNPsMethylScript(SNPMethylFileNameListFileName, perfectLDSNPsFileNameListFileName, chromListFileName, outputFileNameSuffix, distanceCutoff, rCutoff, scriptFileName, codePath)