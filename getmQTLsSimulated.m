function [mQTLsSimulated, mQTLsRandListSimulated] = getmQTLsSimulated(locationsBetasIndividualsMethylFileName, genotypesFiltFileName, SNPMethylFileName, numPerms, numSimulatedReads)
