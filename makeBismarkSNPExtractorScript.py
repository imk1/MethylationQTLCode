def makeBismarkSNPExtractorScript(bismarkSamFileListFileName, SNPVcfStartFileName, suffix, scriptFileName, codePath):
	...
	for line in bismarkSamFileListFile:
		...
		scriptFile.write("python " + codePath + "/" + "bismarkSNPExtractor.py " + bismarkSamFileName + " " + SNPVcfStartFileName + " " + outputFileName + "\n")
...
if __name__=="__main__":
	...
	makeBismarkSNPExtractorScript(bismarkSamFileListFileName, SNPVcfStartFileName, suffix, scriptFileName, codePath)
