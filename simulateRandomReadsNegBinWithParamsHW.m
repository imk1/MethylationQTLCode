function [pValsPooled, pValsIndivs, pValsIndivsGenotype] = simulateRandomReadsNegBinWithParamsHW(numAlleles, numDevFromPerfectCorr, negBinParamsPooled, negBinParamsIndivs, numSimulations, MAF)
...
% binomial distribution whose parameters have been inputted
