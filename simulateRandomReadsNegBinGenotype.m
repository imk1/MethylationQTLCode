function [pValsIndivsGenotype, negBinParamsIndivs] = simulateRandomReadsNegBinGenotype(numAlleles, numMinorAlleles, numDevFromPerfectCorr, numReads, numSimulations, numReadsData)
...
numReadsDataAdjustedIndivs = round((numReadsData/mean(numReadsData)) * (numReads/numIndivs));
