function [pValsPooled, pValsIndivsGenotype] = simulateRandomReadsNegBinCorrWithParamsScaleHWPlusPlus(numAlleles, numDevFromPerfectCorr, negBinParams, numReadsMean, numReads, numSimulations, MAF)
