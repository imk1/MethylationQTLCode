function [pValsPooled, pValsIndivsGenotype] = simulateRandomReadsNegBinFTestWithParamsScaleHWPlusPlusNegative(numAlleles, negBinParams, numReadsMean, numReads, numSimulations, MAF)
