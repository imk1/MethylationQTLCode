def makePrepareFisherExactFDRSNPsMethylationScript(SNPMethylFileListFileName, suffix, minReadsCutoff, MAFCutoff, methylCutoff, scriptFileName, codePath):
	...
	for line in SNPMethylFileListFile:
		...
		cmd = "python " + codePath + "/" + "prepareFisherExactFDRSNPsMethylation.py"
...
if __name__=="__main__":
	...
	makePrepareFisherExactFDRSNPsMethylationScript(SNPMethylFileListFileName, suffix, minReadsCutoff, MAFCutoff, methylCutoff, scriptFileName, codePath)
