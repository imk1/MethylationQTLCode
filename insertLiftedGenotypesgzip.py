...
def insertLiftedGenotypes(genotypesFileName, liftedFileName, unmappedFileName, genotypesLiftedFileName, newAssembly):
	...
	for line in genotypesFile:
		...
		if location not in unmappedLocations:
			...
			genotypesLiftedFile.write(chrom + " " + str(start) + " " + lineElements[3] + " " + newAssembly)
