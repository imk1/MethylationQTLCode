def makeRemoveMethylWithSNPsScript(bismarkMethylationFileListFileName, regionsWithSNPsFileName, CGDist, outputFileNameSuffix, scriptFileName, codePath):
	...
	for line in bismarkMethylationFileListFile:
		...
		scriptFile.write("python " + codePath + "/" + "removeMethylWithSNPs.py " + bismarkMethylationFileName + " " + regionsWithSNPsFileName + " " + str(CGDist) + " " + outputFileName + "\n")
...
if __name__=="__main__":
	...
	makeRemoveMethylWithSNPsScript(bismarkMethylationFileListFileName, regionsWithSNPsFileName, CGDist, outputFileNameSuffix, scriptFileName, codePath)
