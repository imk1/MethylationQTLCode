def makeCorrelateSNPsMethylationRandPlusPlusScriptPart(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFile, scriptFileNamePrefix, codePath, pythonPath, maxLinesPerScript, numLinesInScriptCount, scriptFileNum):
	...
	for line in SNPMethylFileListFile:
		...
		cmd = pythonPath + "/" + "python " + codePath + "/" + "correlateSNPsMethylationPlusPlusRand.py"
...
def makeCorrelateSNPsMethylationPlusPlusRandListScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileNamePrefix, codePath, pythonPath, listStart, listEnd, maxLinesPerScript):
		...
		for i in range(listStart, listEnd + 1):
			...
			[scriptFile, numLinesInScriptCount, scriptFileNum]  = makeCorrelateSNPsMethylationRandPlusPlusScriptPart(SNPMethylFileListFileName, suffixFull, readsToMinMinorReadsFileName, scriptFile, scriptFileNamePrefix, codePath, pythonPath, maxLinesPerScript, numLinesInScriptCount, scriptFileNum)
		scriptFile.close()	
...
if __name__=="__main__":
	...
	makeCorrelateSNPsMethylationPlusPlusRandListScript(SNPMethylFileListFileName, suffix, readsToMinMinorReadsFileName, scriptFileNamePrefix, codePath, pythonPath, listStart, listEnd, maxLinesPerScript)
