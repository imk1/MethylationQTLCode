...
def outputFisherExactPlusPlus(SNP, methyl, SNPVec, methylVec, minReadsCutoff, minReadsCutoffSingleMinor, readsToMinMinorReads, SNPMethylFisherExactFile):
...
def fisherExactSNPsMethylationPlusPlus(SNPMethylFileName, SNPMethylFisherExactFileName, readsToMinMinorReads):
	...
	for line in SNPMethylFile:
		...
		if (currentSNP != lastSNP) or (currentMethyl != lastMethyl):
			...
			outputFisherExactPlusPlus(lastSNP, lastMethyl, SNPVec, methylVec, minReadsCutoff, minReadsCutoffSingleMinor, readsToMinMinorReads, SNPMethylFisherExactFile)
			lastSNP = currentSNP
...
if __name__=="__main__":
	...
	fisherExactSNPsMethylationPlusPlus(SNPMethylFileName, SNPMethylFisherExactFileName, readsToMinMinorReads)
