function [pValsPooled, pValsIndivs, negBinParamsPooled, negBinParamsIndivs] = simulateRandomReadsNegBin(numAlleles, numMinorAlleles, numDevFromPerfectCorr, numReads, numSimulations, numReadsData)
